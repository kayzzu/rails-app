...
class DevelopersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create developer" do
    assert_difference("Developer.count") do
      post developers_url, params: { developer: { email: @developer.email, first_name: @developer.first_name, github: @developer.github, last_name: @developer.last_name, phone: @developer.phone } }
    end
  ...
  test "should update developer" do
    patch developer_url(@developer), params: { developer: { email: @developer.email, first_name: @developer.first_name, github: @developer.github, last_name: @developer.last_name, phone: @developer.phone } }
